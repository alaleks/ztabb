...
zig build test       # 289 юнит-тестов
...
Рамка окна, строка заголовка и её кнопки — системные: они принадлежат
платформе, а не ztabb. В заголовке стоит имя активной вкладки, без имени
программы. Значок и два тона живут в панели вкладок, где их можно нарисовать,
не подменяя ничего нативного.
