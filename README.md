...
весом 500 и на размер мельче терминального: на мелком кегле regular выцветает,
...
Обводки — капсулы, поэтому концы и стыки скруглены. Поскольку это формулы, а не
картинки, иконки выглядят одинаково на любом экране.
