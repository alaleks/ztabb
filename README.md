...
Окно рисует собственную строку заголовка: кнопки закрытия, сворачивания и
разворачивания слева, затем значок терминала, **имя активной вкладки** ярким и
` / ztabb` приглушённым. Системная строка заголовка не умеет ни значка, ни двух
цветов, ни выбранной гарнитуры, поэтому окно безрамочное, а перетаскивание и
изменение размера идут через hit-test SDL.
...
- [x] Собственная строка заголовка со значком и двумя тонами
